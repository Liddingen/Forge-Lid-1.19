...
public class ThrownThunderJug extends ThrowableItemProjectile {
    public ThrownThunderJug(EntityType<? extends ThrownThunderJug> p_37473_, Level p_37474_) {
        super(p_37473_, p_37474_);
    }

    public ThrownThunderJug(Level p_37481_, LivingEntity p_37482_) {
        super(EntityType.EGG, p_37482_, p_37481_);
    }

    public ThrownThunderJug(Level p_37476_, double p_37477_, double p_37478_, double p_37479_) {
