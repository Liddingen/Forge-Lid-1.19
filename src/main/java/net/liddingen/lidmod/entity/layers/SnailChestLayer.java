...
@OnlyIn(Dist.CLIENT)
public class SnailChestLayer extends GeoLayerRenderer<SnailEntity> {
    // A resource location for the texture of the layer. This will be applied onto pre-existing cubes on the model
    private static final ResourceLocation LAYER = new ResourceLocation(LidMod.MOD_ID, "textures/entity/snail_chest_texture.png");
    ...
    public SnailChestLayer(IGeoRenderer<SnailEntity> entityRendererIn) {
