...
@OnlyIn(Dist.CLIENT)
public class SnailSwagLayer extends GeoLayerRenderer<SnailEntity> {
    // A resource location for the texture of the layer. This will be applied onto pre-existing cubes on the model
    private static final ResourceLocation LAYER = new ResourceLocation(LidMod.MOD_ID, "textures/entity/snail_carpet_texture.png");
    ...
    public SnailSwagLayer(IGeoRenderer<SnailEntity> entityRendererIn) {
