...
public class AccumulatorMenu extends AbstractContainerMenu {
    public final AccumulatorEntity blockEntity;
    ...
    public AccumulatorMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.ACCUMULATOR_MENU.get(), id);
        checkContainerSize(inv, 3);
        blockEntity = (AccumulatorEntity) entity;
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.ACCUMULATOR.get());
    }
    ...
    public AccumulatorEntity getBlockEntity() {
